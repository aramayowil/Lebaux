...
import imgInterior from '../../../public/images/aberturas_interiores/img_interior_login.avif'
...
const Login = () => {
    ...
    return (
        <div className="h-full w-full flex bg-black text-white font-sans selection:bg-yellow-500/30 overflow-hidden">
            ...
            {/* BOTÓN DE TEMA: Posicionado arriba a la derecha */}
                ...
                <div className="max-w-[400px] w-full flex flex-col items-center gap-8">
                    ...
                    <form className="w-full flex flex-col gap-4" onSubmit={(e) => e.preventDefault()}>
                        <Input
                            ...
                            classNames={{
                                ...
                                input: "text-base font-normal placeholder:text-zinc-500 text-white"
                            }}
                        />
                        <Input
                            type="password"
                        ...
                        <Link href="#" className="text-sm text-zinc-500 self-center mt-2 font-normal hover:text-yellow-500 transition-colors">
                            ¿Olvidaste tu contraseña?
                        </Link>
                    </form>

                    <div className="w-full border border-zinc-900 py-6 lg:py-8 px-6 text-center mt-4 rounded-sm">
                        <p className="text-base text-zinc-300">
                            ¿No tienes una cuenta?
                            <Link href="/register" className="text-yellow-600 font-semibold text-base ml-1 hover:text-yellow-500">
                                Regístrate
                            </Link>
                        </p>
                    </div>
                    ...
                    <footer className="mt-12 flex flex-col items-center gap-2">
                        ...
                        <p className="text-xs font-medium text-zinc-400 tracking-widest uppercase">
                            © {currentYear} <span className="text-zinc-400">Aberturas Lebaux</span>
                        </p>
                    </footer>
                </div>
            </div>
